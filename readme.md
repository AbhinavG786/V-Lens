...
| Method | Endpoint          | Description                       | Request Type      | Image Upload | API Name                     | ADMIN/USER |
| ------ | ----------------- | --------------------------------- | ----------------- | ------------ | ---------------------------- | ---------- |
| GET    | `/trending`       | Get top trending products         | Query: `?limit=5` | ❌           | getTrendingProducts          | User       |
| GET    | `/random`         | Get random products               | Query: `?limit=5` | ❌           | getRandomProducts            | User       |
| GET    | `/all`            | Get all products                  | Query: `?limit=5` | ❌           | getAllProducts               | User       |
| GET    | `/priceRange`     | Get products by final price range | Query: `?limit=5` | ❌           | getProductsByFinalPriceRange | User       |
...
# Warehouse Routes API – Valsco LensKart

### Base URL: `http://localhost:5000/warehouse`

| Method | Endpoint | Description         | Request Type | Image Upload | API Name            | ADMIN/USER |
| ------ | -------- | ------------------- | ------------ | ------------ | ------------------- | ---------- |
| POST   | `/`      | Create warehouse    | JSON         | ❌           | createWarehouse     | Admin      |
| GET    | `/all`   | Get all warehouses  | JSON         | ❌           | getAllWarehouses    | Admin      |
| GET    | `/:id`   | Get warehouse by ID | JSON         | ❌           | getWarehouseById    | Admin      |
| PATCH  | `/:id`   | Update warehouse    | JSON         | ❌           | updateWarehouseById | Admin      |
| DELETE | `/:id`   | Delete warehouse    | JSON         | ❌           | deleteWarehouseById | Admin      |
