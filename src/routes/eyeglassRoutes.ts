...
router.route("/").post(adminWarehouseAuth.verifyAdminAndWarehouseSession, upload.single('file'), eyeglass.createEyeglass);
...
router.route("/:eyeglassId").patch(adminWarehouseAuth.verifyAdminAndWarehouseSession, upload.single('file'), eyeglass.updateEyeglassProduct);
router.route("/:eyeglassId").delete(adminWarehouseAuth.verifyAdminAndWarehouseSession, eyeglass.deleteEyeglass);
