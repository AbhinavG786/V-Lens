...
import adminStoreWarehouseAuth from '../middlewares/adminStoreWarehouseAuth';

const router = Router();

router.get('/inventory/all',adminAuth.verifyAdminSession, inventory.getAllInventoryItems);
router.get('/inventory/single-item/:warehouseId',adminStoreWarehouseAuth.verifyAdminStoreAndWarehouseSession,inventory.getEachProductStockInWarehouse)
router.get('/inventory/type/:warehouseId',adminStoreWarehouseAuth.verifyAdminStoreAndWarehouseSession,inventory.getAllProductStocksByTypeInWarehouse)
