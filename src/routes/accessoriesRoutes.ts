...
router.route("/").post(adminWarehouseAuth.verifyAdminAndWarehouseSession,upload.single('file'),accessories.createAccessories);
...
router.route("/:accessoriesId").patch(adminWarehouseAuth.verifyAdminAndWarehouseSession,upload.single('file'),accessories.updateAccessoriesProduct);
router.route("/:accessoriesId").delete(adminWarehouseAuth.verifyAdminAndWarehouseSession,accessories.deleteAccessories);
